...
def main():
    ...
    try:
        ...
        field_surface = pg.surfarray.make_surface(field)
        print(field_surface.get_bitsize())
        print(screen.get_bitsize())
        scale(
            field_surface.subsurface(view_rect),
            zoom_view_size,
        ...
        while going:
            ...
            if keys[pg.K_UP]:
                scroll_view(screen, field_surface, DIR_UP, view_rect)
            if keys[pg.K_DOWN]:
                scroll_view(screen, field_surface, DIR_DOWN, view_rect)
            if keys[pg.K_LEFT]:
                scroll_view(screen, field_surface, DIR_LEFT, view_rect)
            if keys[pg.K_RIGHT]:
                scroll_view(screen, field_surface, DIR_RIGHT, view_rect)
            ...
            if direction:
                scroll_view(screen, field_surface, direction, view_rect)
            clock.tick(30)
